...
namespace WebsiteSellingCosmetic.Controllers
{
    [Authorize]
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                WebsiteSellingCosmetic.Common.Common.SendMail("ShopOnline", "Quên mật khẩu", "Truy cập <a href='"+callbackUrl+"'>liên kết này</a> để đặt lại mật khẩu.",model.Email);
