...
using WebsiteSellingCosmetic.Models;
using WebsiteSellingCosmetic.Models.EF;

namespace WebsiteSellingCosmetic.Areas.Admin.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public ActionResult Add(Product model, List<string> Images, List<int> rDefault)
        {
            if (ModelState.IsValid)
            {
                ...
                model.Alias = WebsiteSellingCosmetic.Models.Common.Filter.FilterChar(model.Title);
        ...
        public ActionResult Edit(Product model, List<string> Images, List<int> rDefault)
        {
            if (ModelState.IsValid)
            {
                ...
                if (item != null)
                {
                    ...
                    item.Alias = WebsiteSellingCosmetic.Models.Common.Filter.FilterChar(item.Title);
